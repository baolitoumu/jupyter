...
{
	echo -e "[Notice] Confirm Install - AMH 5.5 \nPlease select your nearest mirror: (1~4)"
...
if [ "${InstallStatus}" == 'success' ]; then
	echo '[AMH] Congratulations, AMH 5.5 install completed.';
	echo "AMH Management: ";
